...
/* bind the context of our function here to "this" of the form */  /* handleSubmit --> from redux-form */
    return (
      <Form onSubmit={handleSubmit(this.onSubmit.bind(this))  }>
        <Heading tag={'h3'}>Create A New Post</Heading>

        <Box>
          <FormField label={"Title"}  htmleFor={"newPost_title"} {...title} >
            <TextInput id="newPost_title" />
          </FormField>
        </Box>

        <Box>
          <FormField label={"Categories"}  htmlFor={"newPost_category"} {...categories} >
            <TextInput id="newPost_category" />
          </FormField>
        </Box>

        <Box>
          <FormField label={"Content"}  htmlFor={"newPost_content"} {...content} >
